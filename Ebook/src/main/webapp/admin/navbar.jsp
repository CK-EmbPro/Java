...
<div class="container-fluid p-3 bg-light">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="row">
                <form class="d-flex  col-md-8  my-lg-0" role="search">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-disabled="true" href="#"><i class="fa-solid fa-book-open"></i> Old Book</a>
                </li>
            </ul>
            <form class="d-flex gap-2 my-lg-0" role="search">
